...
export default function Map(props: any) {
  ...
  const setRedBox = (viewer: Cesium.Viewer) => {
    if (!redBoxRef.current) {
      let redBox = viewer.entities.add({
        id: 'redBox',
        name: 'Red box',
        position: Cesium.Cartesian3.fromDegrees(-112.0, 40.0),
        box: {
          dimensions: new Cesium.Cartesian3(40000.0, 30000.0, 10000.0),
  ...
  const setReferenceProperty = (
    viewer: Cesium.Viewer,
    blueBox: Cesium.Entity,
    redBox: Cesium.Entity,
  ) => {
