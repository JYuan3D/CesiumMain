...
export default function Map(props: any) {
  ...
  const setCallbackProperty = (targetEntity: Cesium.Entity) => {
    let l = 200000.0;
    let property = new Cesium.CallbackProperty(
      (time: Cesium.JulianDate, result: any) => {
    ...
    targetEntity.box!.dimensions = property;
  };
    ...
    <>
      ...
      <div className={styles.btnWrap} style={{ top: 8 }}>
        ...
        <div className={styles.btnItem} style={{ marginBottom: 8 }}>
          <Button
            type="primary"
            onClick={() => setCallbackProperty(blueBoxRef.current)}
          >
            设置Box CallbackProperty
          </Button>
        </div>
      </div>
    </>
