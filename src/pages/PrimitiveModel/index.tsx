...
export default function Map(props: any) {
  ...
  const setModel = (viewer: Cesium.Viewer): Cesium.Model => {
    let origin = Cesium.Cartesian3.fromDegrees(114.0535, 22.557904, 0);
  ...
  const flyModel = (
    ...
    let upPosCartesian3 = ByDirectionAndHeight(position, 90, 1000);
    setPoint(viewer, position, Cesium.Color.RED);
    setPoint(viewer, upPosCartesian3, Cesium.Color.BLUE);
    viewer.camera.flyTo({
      destination: upPosCartesian3,
      orientation: {
